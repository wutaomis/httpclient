...
static void setup(CURL *hnd, int num)
{
  ...
  curl_easy_setopt(hnd, CURLOPT_URL, "http://192.168.12.70:8004/posts/f16f2c08-58fa-48fe-bc9b-e50ed33e24d4");
...
int main(int argc, char **argv)
{
  ...
  curl_multi_setopt(multi_handle, CURLMOPT_MAXCONNECTS , 1L);
